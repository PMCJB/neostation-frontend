...
void main() {
  ...
  setUp(() async {
    ...
    tempMediaDir = await Directory.systemTemp.createTemp('metadata_cleanup_test_');
  ...
  group('MetadataCleanupService', () {
    ...
    test('clean deletes NeoStation rows and media but leaves ES-DE rows untouched', () async {
      ...
      final screenshotsDir = Directory('${tempMediaDir.path}/psx/screenshots');
      await screenshotsDir.create(recursive: true);
      final orphanScreenshot = File('${screenshotsDir.path}/neostation_orphan.png');
    ...
    test('clean removes metadata for individual discs after multi-disc organization', () async {
      ...
      final screenshotsDir = Directory('${tempMediaDir.path}/psx/screenshots');
      await screenshotsDir.create(recursive: true);
      final discOneScreenshot = File('${screenshotsDir.path}/Final Fantasy VIII (Disc 1).png');
      final discTwoScreenshot = File('${screenshotsDir.path}/Final Fantasy VIII (Disc 2).png');
