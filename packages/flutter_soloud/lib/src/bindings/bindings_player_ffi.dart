...
class FlutterSoLoudFfi extends FlutterSoLoud {
  ...
  late final _areOpusOggLibsAvailable = _areOpusOggLibsAvailablePtr
  ...
  late final _isFilterActivePtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int32 Function(ffi.UnsignedInt, ffi.Int32, ffi.Pointer<ffi.Int>)
        >
      >('isFilterActive');
  ...
  @override
  PlayerErrors addFilter(FilterType filterType, {SoundHash? soundHash}) {
  ...
  @override
  PlayerErrors removeFilter(FilterType filterType, {SoundHash? soundHash}) {
